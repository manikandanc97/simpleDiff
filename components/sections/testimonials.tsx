...
const TESTIMONIALS = [
  {
    ...
    stars: 5,
    quote:
      "SimplePrime didn't just build our dashboard — they challenged every assumption we had about the product. The final result is something none of our internal team could have conceived. Three months in and our reconciliation time dropped by 68%.",
    initials: "AM",
  },
  {
    id: "02",
    ...
    stars: 5,
    quote:
      "We'd worked with two agencies before. Both over-promised and under-delivered. SimplePrime was the opposite — realistic scope, weekly visible progress, and a product that our doctors actually enjoy using. Exceptional engineering discipline.",
    initials: "PR",
  },
  {
    id: "03",
  ...
  },
  {
    ...
    stars: 5,
    quote:
      "From onboarding to handover, everything was documented, tracked, and delivered on time. The dispatch system reduced manual ops by 60%. SimplePrime is the kind of technical partner you keep long-term, not just for a project.",
    initials: "MN",
  },
];
