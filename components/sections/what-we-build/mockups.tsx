...
export function WebsitesMockup({ isActive }: { isActive?: boolean }) {
  return (
    <div className="relative w-full h-full min-h-56 sm:min-h-64 flex items-center justify-center select-none">
      ...
      <motion.div 
        ...
        className="relative w-full max-w-80 sm:max-w-80 bg-white/90 backdrop-blur-xl border border-white/80 rounded-2xl shadow-[0_16px_36px_-10px_rgba(0,0,0,0.08),0_2px_8px_rgba(0,0,0,0.02)] p-3.5 sm:p-4 flex flex-col gap-3"
      >
  ...
  return (
    <div className="relative w-full h-full min-h-56 sm:min-h-64 flex items-center justify-center select-none">
      ...
      <motion.div 
        ...
        transition={{ duration: 4, repeat: isActive ? Infinity : 0, ease: "easeInOut" }}
        className="relative w-32 sm:w-36 h-52 sm:h-56 bg-[#121114] rounded-3xl p-2 shadow-[0_20px_40px_-10px_rgba(146,47,85,0.2),0_4px_12px_rgba(0,0,0,0.1)] border-2 border-[#2A2930] flex flex-col overflow-hidden"
      >
        <motion.div 
        ...
        <div className="flex-1 bg-gradient-to-b from-[#FFF5F9] to-[#F3EBF9] rounded-2xl p-2 flex flex-col gap-1.5 relative overflow-hidden">
          <div className="flex items-center gap-1.5 relative z-10">
            <div className="w-5 h-5 rounded-full bg-[#922F55] flex items-center justify-center text-xs text-white font-bold">
              SP
            </div>
            <div className="w-12 h-1.5 rounded-full bg-slate-300" />
          </div>
          ...
          >
            <span className="text-xs font-bold opacity-80">PRO FEATURE</span>
          ...
          <motion.div 
            ...
            transition={{ duration: 6, repeat: isActive ? Infinity : 0, ease: "easeInOut" }}
            className="flex flex-col gap-1.5 w-full absolute top-28 left-0 px-2"
          >
            <div className="flex items-center gap-1.5 bg-white rounded-lg p-1 shadow-2xs">
              <div className="w-4 h-4 rounded-md bg-blue-100 flex items-center justify-center text-[#4BA8FF] text-xs font-bold">A</div>
              <div className="w-14 h-1.5 rounded bg-slate-200" />
            </div>
            <div className="flex items-center gap-1.5 bg-white rounded-lg p-1 shadow-2xs">
              <div className="w-4 h-4 rounded-md bg-pink-100 flex items-center justify-center text-[#D23D78] text-xs font-bold">★</div>
          ...
          <motion.div
            ...
            transition={{ duration: 6, repeat: isActive ? Infinity : 0, ease: "easeInOut" }}
            className="absolute top-28 left-0 px-2 w-full flex flex-col gap-2"
          >
      ...
      >
        <div className="w-6 h-6 rounded-lg bg-[#4BA8FF] flex items-center justify-center text-white font-bold text-xs">A</div>
      </motion.div>
      <motion.div 
        animate={isActive ? { y: [0, 10, 0], rotate: [6, 2, 6] } : { y: 0, rotate: 6 }}
      ...
      >
        <div className="w-6 h-6 rounded-lg bg-[#922F55] flex items-center justify-center text-white font-bold text-xs">99%</div>
      </motion.div>
    </div>
  );
}
    ...
    <div className="relative w-full h-full min-h-56 sm:min-h-64 flex items-center justify-center select-none">
      ...
      >
        <div className="flex items-center justify-between pb-1 border-b border-black/[0.04]">
          ...
          <span className="text-xs font-bold text-[#08B875] bg-emerald-50 px-2 py-0.5 rounded-full">+148% MRR</span>
        </div>
        ...
        <div className="bg-gradient-to-br from-[#922F55] to-[#6C2BB8] rounded-xl p-3 text-white flex flex-col gap-2 shadow-md relative overflow-hidden">
          ...
          <div className="flex items-center justify-between relative z-10">
            ...
            <span className="text-sm font-black">$499<span className="text-xs font-normal opacity-80">/mo</span></span>
          </div>
